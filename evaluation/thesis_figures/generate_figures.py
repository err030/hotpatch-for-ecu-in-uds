...
FINAL_TIMING_RESULTS = RESULTS / "20260716_final_firmware_timing"
...
def load_fuzz_data():
    hardware = read_csv(RESULTS / "20260710_hardware_fuzz" / "hardware_fuzz_paired_detail.csv")
    vcan = read_csv(RESULTS / "20260710_vcan" / "vcan_paired_detail.csv")
...
def fleet_data():
    base = RESULTS / "20260710_fleet_main"
    ts = read_csv(base / "fleet_ota_exposure_20260710_paired_hardware_1000v_60d_timeseries.csv")
    summary = read_csv(base / "fleet_ota_exposure_20260710_paired_hardware_1000v_60d_summary.csv")
    return ts, summary
...
def fig59_sensitivity() -> None:
    all_rows = read_csv(RESULTS / "20260710_fleet_event_sensitivity" / "fleet_event_sensitivity_detail.csv")
    selected = [
        {
