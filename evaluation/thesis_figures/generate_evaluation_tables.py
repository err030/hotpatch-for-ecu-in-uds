...
BENIGN_RESULTS = RESULTS / "20260710_paired_hardware"
...
def build_software_hardware_agreement():
    hardware_all = read_csv(RESULTS / "20260710_hardware_fuzz" / "hardware_fuzz_paired_detail.csv")
...
def build_resource_table():
    base_dir = ROOT / "hardware level" / "board_baseline"
    ...
    rows = [
        ...
        {"metric": "CPU utilisation / task jitter", "vulnerable_profile": "not instrumented", "kintsugi_runtime": "not instrumented", "delta_or_status": "unavailable", "evidence": "20260710 activation telemetry status"},
    ]
